...
export { type IntensidadHoraria } from "./intensidad.interface";
export { type Comentario } from "./comentarios.interface";
export { type SubActividad } from "./subactividad.interface";
export { type Actividad } from "./actvidad.interface";
