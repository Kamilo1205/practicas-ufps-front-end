        ...
        <table className="min-w-full border-gray-300">
          <thead>
            <tr>
              ...
              <th className="text-gray-900 font-semibold text-sm text-left pl-0 pr-3 py-3.5">Convenio</th>
              <th className="text-gray-900 font-semibold text-sm text-left pl-0 pr-3 py-3.5">Nit</th>
              <th className="text-gray-900 font-semibold text-sm text-left pl-0 pr-3 py-3.5">Dirección</th>
              <th className="text-gray-900 font-semibold text-sm text-left pl-0 pr-3 py-3.5">Telefono</th>
                ...
                <tr key={empresa.id} className="cursor-pointer">
                  <td className="text-sm whitespace-nowrap pl-0 pr-3 py-5">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <div className="text-gray-900 font-medium">{ empresa.nombre || 'Nombre aun no registrado' }</div>
                        <div className="text-gray-500 mt-1">{ empresa.usuario.email }</div>
                      </div>
                    </div>
                  </td>
                  <td className="text-sm whitespace-nowrap pl-0 pr-3 py-5">
                  ...
                  <td className="text-sm whitespace-nowrap capitalize text-gray-500">{ empresa.nit }</td>
                  <td className="text-sm whitespace-nowrap capitalize text-gray-500">
                    <div>{ empresa.direccion }</div>
                    <div>{ empresa.ciudad }, { empresa.pais }</div>
                  </td>
                  <td className="text-sm whitespace-nowrap capitalize text-gray-500">{ empresa.telefono }</td>
                  <td className="text-sm whitespace-nowrap capitalize text-gray-500">{ new Date(empresa.fechaCreacion).toLocaleDateString() }</td>
                  <td className="text-sm whitespace-nowrap pl-0 pr-3 py-5">
                    {
